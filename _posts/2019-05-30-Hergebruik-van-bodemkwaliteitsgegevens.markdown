...
Zo langzamerhand wordt het best ingewikkeld! Daarom heb ik [FME Desktop](https://www.safe.com/fme/fme-desktop/) gebruikt om een script te bouwen voor het genereren van de requests en samenvoegen van de responses. Het script is te [downloaden](https://github.com/FrieseWoudloper/FME_workspaces/blob/master/bodemloket) van GitHub.
